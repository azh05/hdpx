...
extract_components <-  function(sample.chains,
  ...
  cosine.dist.df <-
    parallelDist::parallelDist(t(dataframe.normed),
                               method = "cosine")
